...
class Analyze(object):
    ...
    def calc(self):
        ...
        按6推1的方式计算中奖情况
        """
        for index in range(len(self._data)-6):
            ...
            seven_prize_num = (int(seven[2]), int(seven[3]), int(seven[4]))
            ...
            if len(diff_set) == 2:
                # 中奖了
                if diff_set.pop() in seven_prize_num and diff_set.pop() in seven_prize_num:
