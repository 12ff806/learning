...
class Analyze(object):
    ...
    def calc(self):
        ...
        for index in range(len(self._data)-3):
            ...
            if len(diff_set) == 2:
                # 中奖了
                if diff_set.pop() in four_prize_num and diff_set.pop() in four_prize_num:
                    self._winning_record.append((four[1], self._purchase_num_per_circle+1))
                    self._purchase_num_per_circle = 0
                    self._prize_num += 1
